    ...
    <div style={{
      ...
      <div style={{ padding: '12px 14px', flex: 1, display: 'flex', flexDirection: 'column', gap: 8 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 8 }}>
          ...
          {isOwn && (
            <span style={{ background: 'rgba(139,34,118,.15)', color: 'var(--purple2)', fontSize: '0.7rem', fontWeight: 700, borderRadius: 99, padding: '2px 8px', whiteSpace: 'nowrap', flexShrink: 0 }}>
              Ma vente
            </span>
          )}
        </div>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 14, flexWrap: 'wrap' }}>
        {[
          ...
          <button key={m.id} onClick={() => setMethod(m.id)} style={{
            ...
            background: method === m.id ? 'rgba(244,154,14,.12)' : 'transparent',
